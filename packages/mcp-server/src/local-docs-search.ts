...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['id: string;'],
    response:
      "{ id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }",
    markdown:
  ...
  },
  {
    ...
    params: [
      '{ body: { markdown?: string; }; inbox_id: string; subject: string; to: { email: string; name?: string; }[]; bcc?: { email: string; name?: string; }[]; cc?: { email: string; name?: string; }[]; } | { body: { markdown?: string; }; conversation_id: string; inbox_id: string; bcc?: { email: string; name?: string; }[]; cc?: { email: string; name?: string; }[]; to?: { email: string; name?: string; }[]; };',
    ],
    response:
      "{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }",
    markdown:
      "## create\n\n`client.inboxMessages.create(body: { body: object; inbox_id: string; subject: string; to: object[]; bcc?: object[]; cc?: object[]; } | { body: object; conversation_id: string; inbox_id: string; bcc?: object[]; cc?: object[]; to?: object[]; }): { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }`\n\n**post** `/inbox_messages`\n\nCreates a new message draft.\n\n### Parameters\n\n- `body: { body: { markdown?: string; }; inbox_id: string; subject: string; to: { email: string; name?: string; }[]; bcc?: { email: string; name?: string; }[]; cc?: { email: string; name?: string; }[]; } | { body: { markdown?: string; }; conversation_id: string; inbox_id: string; bcc?: { email: string; name?: string; }[]; cc?: { email: string; name?: string; }[]; to?: { email: string; name?: string; }[]; }`\n  Parameters for creating an email message draft. Provide either the fields for a new conversation, or a `conversation_id` to reply to an existing conversation.\n\n### Returns\n\n- `{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }`\n  The Email Message object represents a single email within a `Conversation`.\n\n  - `id: string`\n  - `body: { markdown?: string; }`\n  - `bulk: boolean`\n  - `created_at: string`\n  - `draft: boolean`\n  - `lock_version: number`\n  - `spam: boolean`\n  - `subject: string`\n  - `trash: boolean`\n  - `type: 'email_message'`\n  - `unread: boolean`\n  - `addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: { id: string; collection: collection_pointer; type: 'item'; }; person?: { id: string; collection: collection_pointer; type: 'item'; }; }[]`\n  - `attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]`\n  - `conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: { id: string; created_at: string; name: string; tagsets: tagset_pointer[]; type: 'inbox'; updated_at: string; can_read?: boolean; }; messages?: { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }[]; unsnooze_at?: string; }`\n  - `summary?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst emailMessage = await client.inboxMessages.create({ body: {\n  body: {},\n  inbox_id: '1CLJt2v6KXDyzDuM57pQqo',\n  subject: 'Test Subject',\n  to: [{ email: 'bob@example.com' }, { email: 'jack@example.com' }],\n} });\n\nconsole.log(emailMessage);\n```",
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'inbox_messages.create',
        example:
          'require "moonbase"\n\nmoonbase = Moonbase::Client.new(api_key: "My API Key")\n\nemail_message = moonbase.inbox_messages.create(\n  body: {\n    body: {},\n    inbox_id: "1CLJt2v6KXDyzDuM57pQqo",\n    subject: "Test Subject",\n    to: [{email: "bob@example.com"}, {email: "jack@example.com"}]\n  }\n)\n\nputs(email_message)',
      },
      http: {
        example:
