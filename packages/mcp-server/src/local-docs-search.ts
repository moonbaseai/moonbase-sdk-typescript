...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['after?: string;', 'before?: string;', 'limit?: number;'],
    response:
      "{ id: string; created_at: string; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; }",
    markdown:
      "## list\n\n`client.collections.list(after?: string, before?: string, limit?: number): { id: string; created_at: string; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; }`\n\n**get** `/collections`\n\nReturns a list of your collections.\n\n### Parameters\n\n- `after?: string`\n  When specified, returns results starting immediately after the item identified by this cursor. Use the cursor value from the previous response's metadata to fetch the next page of results.\n\n- `before?: string`\n  When specified, returns results starting immediately before the item identified by this cursor. Use the cursor value from the response's metadata to fetch the previous page of results.\n\n- `limit?: number`\n  Maximum number of items to return per page. Must be between 1 and 100. Defaults to 20 if not specified.\n\n### Returns\n\n- `{ id: string; created_at: string; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; }`\n  Information about the most essential attributes of a Collection (does not include the collection's field definitions).\n\n  - `id: string`\n  - `created_at: string`\n  - `kind: 'system' | 'form' | 'custom'`\n  - `name: string`\n  - `ref: string`\n  - `type: 'collection'`\n  - `updated_at: string`\n  - `description?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\n// Automatically fetches more pages as needed.\nfor await (const collectionListResponse of client.collections.list()) {\n  console.log(collectionListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['id: string;'],
    response:
      "{ id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }",
    markdown:
      "## retrieve\n\n`client.collections.retrieve(id: string): { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }`\n\n**get** `/collections/{id}`\n\nRetrieves the details of an existing collection.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }`\n  A Collection is a container for structured data, similar to a database table or spreadsheet. It defines a schema using a set of `Fields` and holds the data as a list of `Items`.\n\n\n  - `id: string`\n  - `created_at: string`\n  - `fields: { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/text/single_line'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/text/multi_line'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/unitless_integer'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/unitless_float'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_unit: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/monetary'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/percentage'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/boolean'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/email'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/url'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/domain'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/social_x'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/social_linked_in'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/telephone_number'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/geo'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/date'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/datetime'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; options: object[]; readonly: boolean; ref: string; required: boolean; type: 'field/choice'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; funnel: object; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/stage'; unique: boolean; updated_at: string; description?: string; } | { id: string; allowed_collections: object[]; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; relation_type: 'one_way' | 'two_way'; required: boolean; type: 'field/relation'; unique: boolean; updated_at: string; description?: string; reverse_field_name?: string; reverse_fields?: object[]; source_field?: object; }[]`\n  - `kind: 'system' | 'form' | 'custom'`\n  - `name: string`\n  - `ref: string`\n  - `type: 'collection'`\n  - `updated_at: string`\n  - `description?: string`\n  - `views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; }[]`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst collection = await client.collections.retrieve('id');\n\nconsole.log(collection);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }",
    markdown:
      "## update\n\n`client.collections.update(id: string, description?: string, name?: string): { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }`\n\n**patch** `/collections/{id}`\n\nUpdates an existing collection.\n\n### Parameters\n\n- `id: string`\n\n- `description?: string`\n  An optional, longer-form description of the collection's purpose.\n\n- `name?: string`\n  The user-facing name of the collection.\n\n### Returns\n\n- `{ id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }`\n  A Collection is a container for structured data, similar to a database table or spreadsheet. It defines a schema using a set of `Fields` and holds the data as a list of `Items`.\n\n\n  - `id: string`\n  - `created_at: string`\n  - `fields: { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/text/single_line'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/text/multi_line'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/unitless_integer'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/unitless_float'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_unit: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/monetary'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/percentage'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/boolean'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/email'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/url'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/domain'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/social_x'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/social_linked_in'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/telephone_number'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/geo'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/date'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/datetime'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; options: object[]; readonly: boolean; ref: string; required: boolean; type: 'field/choice'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; funnel: object; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/stage'; unique: boolean; updated_at: string; description?: string; } | { id: string; allowed_collections: object[]; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; relation_type: 'one_way' | 'two_way'; required: boolean; type: 'field/relation'; unique: boolean; updated_at: string; description?: string; reverse_field_name?: string; reverse_fields?: object[]; source_field?: object; }[]`\n  - `kind: 'system' | 'form' | 'custom'`\n  - `name: string`\n  - `ref: string`\n  - `type: 'collection'`\n  - `updated_at: string`\n  - `description?: string`\n  - `views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; }[]`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst collection = await client.collections.update('id');\n\nconsole.log(collection);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## create\n\n`client.collections.fields.create(collection_id: string, field: { name: string; type: 'field/text/single_line'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/text/multi_line'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/unitless_integer'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/unitless_float'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/monetary'; cardinality?: 'one' | 'many'; default_unit?: string; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/percentage'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/boolean'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/email'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/url'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/domain'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/social_x'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/social_linked_in'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/telephone_number'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/geo'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/date'; cardinality?: 'one' | 'many'; default_values?: date_value | current_date[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/datetime'; cardinality?: 'one' | 'many'; default_values?: datetime_value | current_datetime[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; options: { color: string; name: string; }[]; type: 'field/choice'; cardinality?: 'one' | 'many'; default_values?: object[]; description?: string; required?: boolean; unique?: boolean; } | { funnel: funnel_pointer_param; name: string; type: 'field/stage'; cardinality?: 'one' | 'many'; default_values?: funnel_step_value_param[]; description?: string; required?: boolean; unique?: boolean; } | { allowed_collections: { type: 'collection'; id?: string; ref?: string; }[]; name: string; relation_type: 'one_way' | 'two_way'; type: 'field/relation'; cardinality?: 'one' | 'many'; default_values?: relation_value_param | current_member[]; description?: string; required?: boolean; reverse_field_name?: string; unique?: boolean; }): object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object`\n\n**post** `/collections/{collection_id}/fields`\n\nCreates a new field in a collection.\n\n### Parameters\n\n- `collection_id: string`\n\n- `field: { name: string; type: 'field/text/single_line'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/text/single_line'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/text/multi_line'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/text/multi_line'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/unitless_integer'; cardinality?: 'one' | 'many'; default_values?: { data: number; type: 'value/number/unitless_integer'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/unitless_float'; cardinality?: 'one' | 'many'; default_values?: { data: number; type: 'value/number/unitless_float'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/monetary'; cardinality?: 'one' | 'many'; default_unit?: string; default_values?: { data: { currency: string; in_minor_units: number; }; type: 'value/number/monetary'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/number/percentage'; cardinality?: 'one' | 'many'; default_values?: { data: number; type: 'value/number/percentage'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/boolean'; cardinality?: 'one' | 'many'; default_values?: { data: boolean; type: 'value/boolean'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/email'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/email'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/url'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/uri/url'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/domain'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/uri/domain'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/social_x'; cardinality?: 'one' | 'many'; default_values?: { data: object; type: 'value/uri/social_x'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/uri/social_linked_in'; cardinality?: 'one' | 'many'; default_values?: { data: object; type: 'value/uri/social_linked_in'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/telephone_number'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/telephone_number'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/geo'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/geo'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/date'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/date'; } | { type: 'current_date'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; type: 'field/datetime'; cardinality?: 'one' | 'many'; default_values?: { data: string; type: 'value/datetime'; } | { type: 'current_datetime'; }[]; description?: string; required?: boolean; unique?: boolean; } | { name: string; options: { color: string; name: string; }[]; type: 'field/choice'; cardinality?: 'one' | 'many'; default_values?: { data: object; type: 'value/choice'; }[]; description?: string; required?: boolean; unique?: boolean; } | { funnel: { id: string; type: 'funnel'; }; name: string; type: 'field/stage'; cardinality?: 'one' | 'many'; default_values?: { data: funnel_step_pointer; type: 'value/funnel_step'; }[]; description?: string; required?: boolean; unique?: boolean; } | { allowed_collections: { type: 'collection'; id?: string; ref?: string; }[]; name: string; relation_type: 'one_way' | 'two_way'; type: 'field/relation'; cardinality?: 'one' | 'many'; default_values?: { data: item_pointer_param; type: 'value/relation'; } | { type: 'current_member'; }[]; description?: string; required?: boolean; reverse_field_name?: string; unique?: boolean; }`\n  Parameters for creating a field, discriminated by `type`.\n\n### Returns\n\n- `{ id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/text/single_line'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/text/multi_line'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/unitless_integer'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/unitless_float'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_unit: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/monetary'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/number/percentage'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/boolean'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/email'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/url'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/domain'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/social_x'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/uri/social_linked_in'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/telephone_number'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/geo'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/date'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/datetime'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; options: object[]; readonly: boolean; ref: string; required: boolean; type: 'field/choice'; unique: boolean; updated_at: string; description?: string; } | { id: string; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; funnel: object; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; required: boolean; type: 'field/stage'; unique: boolean; updated_at: string; description?: string; } | { id: string; allowed_collections: object[]; cardinality: 'one' | 'many'; created_at: string; default_values: single_line_text_value | multi_line_text_value | integer_value | float_value | monetary_value | percentage_value | boolean_value | email_value | url_value | domain_value | social_x_value | social_linked_in_value | telephone_number | geo_value | date_value | current_date | datetime_value | current_datetime | choice_value | funnel_step_value | relation_value | current_member[]; kind: 'system' | 'inverse' | 'custom'; name: string; readonly: boolean; ref: string; relation_type: 'one_way' | 'two_way'; required: boolean; type: 'field/relation'; unique: boolean; updated_at: string; description?: string; reverse_field_name?: string; reverse_fields?: object[]; source_field?: object; }`\n  A field definition, which varies by type\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst field = await client.collections.fields.create('collection_id', { field: { name: 'Lead Source', type: 'field/text/single_line' } });\n\nconsole.log(field);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; }",
    markdown:
      "## retrieve\n\n`client.views.retrieve(id: string, include?: 'collection'[]): { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }`\n\n**get** `/views/{id}`\n\nRetrieves the details of an existing view.\n\n### Parameters\n\n- `id: string`\n\n- `include?: 'collection'[]`\n  Specifies which related objects to include in the response. Valid option is `collection`.\n\n### Returns\n\n- `{ id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; }`\n  A View represents a saved configuration for displaying items in a collection, including filters and sorting rules.\n\n  - `id: string`\n  - `created_at: string`\n  - `name: string`\n  - `type: 'view'`\n  - `updated_at: string`\n  - `view_type: 'table' | 'board'`\n  - `collection?: { id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst view = await client.views.retrieve('id');\n\nconsole.log(view);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: "{ id: string; type: 'email_message'; }",
    markdown:
      "## list\n\n`client.inboxMessages.list(after?: string, before?: string, conversation_id?: { eq?: string; }, inbox_id?: { eq?: string; }, limit?: number): { id: string; type: 'email_message'; }`\n\n**get** `/inbox_messages`\n\nReturns a list of messages.\n\n### Parameters\n\n- `after?: string`\n  When specified, returns results starting immediately after the item identified by this cursor. Use the cursor value from the previous response's metadata to fetch the next page of results.\n\n- `before?: string`\n  When specified, returns results starting immediately before the item identified by this cursor. Use the cursor value from the response's metadata to fetch the previous page of results.\n\n- `conversation_id?: { eq?: string; }`\n  - `eq?: string`\n\n- `inbox_id?: { eq?: string; }`\n  - `eq?: string`\n\n- `limit?: number`\n  Maximum number of items to return per page. Must be between 1 and 100. Defaults to 20 if not specified.\n\n### Returns\n\n- `{ id: string; type: 'email_message'; }`\n\n  - `id: string`\n  - `type: 'email_message'`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\n// Automatically fetches more pages as needed.\nfor await (const emailMessagePointer of client.inboxMessages.list()) {\n  console.log(emailMessagePointer);\n}\n```",
    perLanguage: {
      typescript: {
        method: 'client.inboxMessages.list',
        example:
          "import Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase({\n  apiKey: process.env['MOONBASE_API_KEY'], // This is the default and can be omitted\n});\n\n// Automatically fetches more pages as needed.\nfor await (const emailMessagePointer of client.inboxMessages.list()) {\n  console.log(emailMessagePointer.id);\n}",
      },
      python: {
  ...
  },
  {
    ...
    response:
      "{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }",
    markdown:
      "## retrieve\n\n`client.inboxMessages.retrieve(id: string, include?: 'addresses' | 'attachments' | 'conversation'[]): { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }`\n\n**get** `/inbox_messages/{id}`\n\nRetrieves the details of an existing message.\n\n### Parameters\n\n- `id: string`\n\n- `include?: 'addresses' | 'attachments' | 'conversation'[]`\n  Specifies which related objects to include in the response. Valid options are `addresses`, `attachments`, and `conversation`.\n\n### Returns\n\n- `{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }`\n  The Email Message object represents a single email within a `Conversation`.\n\n  - `id: string`\n  - `body: { markdown?: string; }`\n  - `bulk: boolean`\n  - `created_at: string`\n  - `draft: boolean`\n  - `lock_version: number`\n  - `spam: boolean`\n  - `subject: string`\n  - `trash: boolean`\n  - `type: 'email_message'`\n  - `unread: boolean`\n  - `addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: { id: string; collection: collection_pointer; type: 'item'; }; person?: { id: string; collection: collection_pointer; type: 'item'; }; }[]`\n  - `attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]`\n  - `conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: { id: string; created_at: string; name: string; tagsets: tagset_pointer[]; type: 'inbox'; updated_at: string; can_read?: boolean; }; messages?: { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }[]; unsnooze_at?: string; }`\n  - `summary?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst emailMessage = await client.inboxMessages.retrieve('id');\n\nconsole.log(emailMessage);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }",
    markdown:
      "## create\n\n`client.inboxMessages.create(body: { markdown?: string; }, inbox_id: string, bcc?: { email: string; name?: string; }[], cc?: { email: string; name?: string; }[], conversation_id?: string, subject?: string, to?: { email: string; name?: string; }[]): { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }`\n\n**post** `/inbox_messages`\n\nCreates a new message draft.\n\n### Parameters\n\n- `body: { markdown?: string; }`\n  The email body.\n  - `markdown?: string`\n    The content formatted as Markdown text.\n\n- `inbox_id: string`\n  The inbox to use for sending the email.\n\n- `bcc?: { email: string; name?: string; }[]`\n  A list of the BCC recipients.\n\n- `cc?: { email: string; name?: string; }[]`\n  A list of the CC recipients.\n\n- `conversation_id?: string`\n  The ID of the conversation, if responding to an existing conversation.\n\n- `subject?: string`\n  The subject line of the email.\n\n- `to?: { email: string; name?: string; }[]`\n  A list of recipients.\n\n### Returns\n\n- `{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }`\n  The Email Message object represents a single email within a `Conversation`.\n\n  - `id: string`\n  - `body: { markdown?: string; }`\n  - `bulk: boolean`\n  - `created_at: string`\n  - `draft: boolean`\n  - `lock_version: number`\n  - `spam: boolean`\n  - `subject: string`\n  - `trash: boolean`\n  - `type: 'email_message'`\n  - `unread: boolean`\n  - `addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: { id: string; collection: collection_pointer; type: 'item'; }; person?: { id: string; collection: collection_pointer; type: 'item'; }; }[]`\n  - `attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]`\n  - `conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: { id: string; created_at: string; name: string; tagsets: tagset_pointer[]; type: 'inbox'; updated_at: string; can_read?: boolean; }; messages?: { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }[]; unsnooze_at?: string; }`\n  - `summary?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst emailMessage = await client.inboxMessages.create({\n  body: {},\n  inbox_id: '1CLJt2v6KXDyzDuM57pQqo',\n});\n\nconsole.log(emailMessage);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }",
    markdown:
      "## update\n\n`client.inboxMessages.update(id: string, lock_version: number, bcc?: { email: string; name?: string; }[], body?: { markdown?: string; }, cc?: { email: string; name?: string; }[], subject?: string, to?: { email: string; name?: string; }[]): { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }`\n\n**patch** `/inbox_messages/{id}`\n\nUpdates an existing message draft.\n\n### Parameters\n\n- `id: string`\n\n- `lock_version: number`\n  The current lock version of the draft for optimistic concurrency control.\n\n- `bcc?: { email: string; name?: string; }[]`\n  A list of the BCC recipients.\n\n- `body?: { markdown?: string; }`\n  The email body.\n  - `markdown?: string`\n    The content formatted as Markdown text.\n\n- `cc?: { email: string; name?: string; }[]`\n  A list of the CC recipients.\n\n- `subject?: string`\n  The subject line of the email.\n\n- `to?: { email: string; name?: string; }[]`\n  A list of the recipients.\n\n### Returns\n\n- `{ id: string; body: { markdown?: string; }; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: item_pointer; person?: item_pointer; }[]; attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]; conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: tag[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: inbox; messages?: email_message[]; unsnooze_at?: string; }; summary?: string; }`\n  The Email Message object represents a single email within a `Conversation`.\n\n  - `id: string`\n  - `body: { markdown?: string; }`\n  - `bulk: boolean`\n  - `created_at: string`\n  - `draft: boolean`\n  - `lock_version: number`\n  - `spam: boolean`\n  - `subject: string`\n  - `trash: boolean`\n  - `type: 'email_message'`\n  - `unread: boolean`\n  - `addresses?: { id: string; email: string; role: 'from' | 'reply_to' | 'to' | 'cc' | 'bcc'; type: 'message_address'; organization?: { id: string; collection: collection_pointer; type: 'item'; }; person?: { id: string; collection: collection_pointer; type: 'item'; }; }[]`\n  - `attachments?: { id: string; created_at: string; download_url: string; filename: string; size: number; type: 'message_attachment'; }[]`\n  - `conversation?: { id: string; bulk: boolean; created_at: string; draft: boolean; follow_up: boolean; last_message_at: string; spam: boolean; state: 'unassigned' | 'active' | 'closed' | 'waiting'; subject: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; trash: boolean; type: 'inbox_conversation'; unread: boolean; updated_at: string; inbox?: { id: string; created_at: string; name: string; tagsets: tagset_pointer[]; type: 'inbox'; updated_at: string; can_read?: boolean; }; messages?: { id: string; body: formatted_text; bulk: boolean; created_at: string; draft: boolean; lock_version: number; spam: boolean; subject: string; trash: boolean; type: 'email_message'; unread: boolean; addresses?: address[]; attachments?: message_attachment[]; conversation?: inbox_conversation; summary?: string; }[]; unsnooze_at?: string; }`\n  - `summary?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst emailMessage = await client.inboxMessages.update('id', { lock_version: 0 });\n\nconsole.log(emailMessage);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['after?: string;', 'before?: string;', 'limit?: number;'],
    response:
      "{ id: string; created_at: string; name: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; type: 'tagset'; updated_at: string; description?: string; }",
    markdown:
      "## list\n\n`client.tagsets.list(after?: string, before?: string, limit?: number): { id: string; created_at: string; name: string; tags: tag[]; type: 'tagset'; updated_at: string; description?: string; }`\n\n**get** `/tagsets`\n\nReturns a list of your tagsets.\n\n### Parameters\n\n- `after?: string`\n  When specified, returns results starting immediately after the item identified by this cursor. Use the cursor value from the previous response's metadata to fetch the next page of results.\n\n- `before?: string`\n  When specified, returns results starting immediately before the item identified by this cursor. Use the cursor value from the response's metadata to fetch the previous page of results.\n\n- `limit?: number`\n  Maximum number of items to return per page. Must be between 1 and 100. Defaults to 20 if not specified.\n\n### Returns\n\n- `{ id: string; created_at: string; name: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; type: 'tagset'; updated_at: string; description?: string; }`\n  A Tagset is a collection of `Tag` objects whose tags can be applied to conversations, calls, and meetings.\n\n  - `id: string`\n  - `created_at: string`\n  - `name: string`\n  - `tags: { id: string; color: string; name: string; type: 'tag'; }[]`\n  - `type: 'tagset'`\n  - `updated_at: string`\n  - `description?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\n// Automatically fetches more pages as needed.\nfor await (const tagset of client.tagsets.list()) {\n  console.log(tagset);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; name: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; type: 'tagset'; updated_at: string; description?: string; }",
    markdown:
      "## retrieve\n\n`client.tagsets.retrieve(id: string): { id: string; created_at: string; name: string; tags: tag[]; type: 'tagset'; updated_at: string; description?: string; }`\n\n**get** `/tagsets/{id}`\n\nRetrieves the details of an existing tagset.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; name: string; tags: { id: string; color: string; name: string; type: 'tag'; }[]; type: 'tagset'; updated_at: string; description?: string; }`\n  A Tagset is a collection of `Tag` objects whose tags can be applied to conversations, calls, and meetings.\n\n  - `id: string`\n  - `created_at: string`\n  - `name: string`\n  - `tags: { id: string; color: string; name: string; type: 'tag'; }[]`\n  - `type: 'tagset'`\n  - `updated_at: string`\n  - `description?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst tagset = await client.tagsets.retrieve('id');\n\nconsole.log(tagset);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['after?: string;', 'before?: string;', 'limit?: number;'],
    response:
      "{ id: string; business_email_required: boolean; collection: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; created_at: string; name: string; pages_enabled: boolean; type: 'form'; updated_at: string; pages_url?: string; redirect_url?: string; }",
    markdown:
      "## list\n\n`client.forms.list(after?: string, before?: string, limit?: number): { id: string; business_email_required: boolean; collection: collection; created_at: string; name: string; pages_enabled: boolean; type: 'form'; updated_at: string; pages_url?: string; redirect_url?: string; }`\n\n**get** `/forms`\n\nReturns a list of your forms.\n\n### Parameters\n\n- `after?: string`\n  When specified, returns results starting immediately after the item identified by this cursor. Use the cursor value from the previous response's metadata to fetch the next page of results.\n\n- `before?: string`\n  When specified, returns results starting immediately before the item identified by this cursor. Use the cursor value from the response's metadata to fetch the previous page of results.\n\n- `limit?: number`\n  Maximum number of items to return per page. Must be between 1 and 100. Defaults to 20 if not specified.\n\n### Returns\n\n- `{ id: string; business_email_required: boolean; collection: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; created_at: string; name: string; pages_enabled: boolean; type: 'form'; updated_at: string; pages_url?: string; redirect_url?: string; }`\n  A Form provides a way to create `Items` in a `Collection`, often via a public URL for external users. Each form submission creates a new item.\n\n  - `id: string`\n  - `business_email_required: boolean`\n  - `collection: { id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }`\n  - `created_at: string`\n  - `name: string`\n  - `pages_enabled: boolean`\n  - `type: 'form'`\n  - `updated_at: string`\n  - `pages_url?: string`\n  - `redirect_url?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\n// Automatically fetches more pages as needed.\nfor await (const form of client.forms.list()) {\n  console.log(form);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; business_email_required: boolean; collection: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; created_at: string; name: string; pages_enabled: boolean; type: 'form'; updated_at: string; pages_url?: string; redirect_url?: string; }",
    markdown:
      "## retrieve\n\n`client.forms.retrieve(id: string): { id: string; business_email_required: boolean; collection: collection; created_at: string; name: string; pages_enabled: boolean; type: 'form'; updated_at: string; pages_url?: string; redirect_url?: string; }`\n\n**get** `/forms/{id}`\n\nRetrieves the details of an existing form.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; business_email_required: boolean; collection: { id: string; created_at: string; fields: field[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: view[]; }; created_at: string; name: string; pages_enabled: boolean; type: 'form'; updated_at: string; pages_url?: string; redirect_url?: string; }`\n  A Form provides a way to create `Items` in a `Collection`, often via a public URL for external users. Each form submission creates a new item.\n\n  - `id: string`\n  - `business_email_required: boolean`\n  - `collection: { id: string; created_at: string; fields: object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object[]; kind: 'system' | 'form' | 'custom'; name: string; ref: string; type: 'collection'; updated_at: string; description?: string; views?: { id: string; created_at: string; name: string; type: 'view'; updated_at: string; view_type: 'table' | 'board'; collection?: collection; }[]; }`\n  - `created_at: string`\n  - `name: string`\n  - `pages_enabled: boolean`\n  - `type: 'form'`\n  - `updated_at: string`\n  - `pages_url?: string`\n  - `redirect_url?: string`\n\n### Example\n\n```typescript\nimport Moonbase from '@moonbaseai/sdk';\n\nconst client = new Moonbase();\n\nconst form = await client.forms.retrieve('id');\n\nconsole.log(form);\n```",
    perLanguage: {
      typescript: {
