...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      'include[]': {
        type: 'string',
        description: 'Specifies which related objects to include in the response. Valid option is `tagsets`.',
        enum: ['tagsets'],
      },
      jq_filter: {
        type: 'string',
